...
export const alt = 'The Piyumverse — Blog'
export const size = {
  width: 1200,
  height: 630,
}
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            display: 'flex',
            background: 'linear-gradient(to top, rgba(3,19,28,0.96) 0%, rgba(3,19,28,0.55) 55%, rgba(3,19,28,0.2) 100%)',
          }}
        />
        <div style={{ position: 'relative', display: 'flex', padding: '64px 84px', flexDirection: 'column' }}>
          <div style={{ fontSize: 26, color: '#72E5F8', letterSpacing: '0.3em', marginBottom: 24 }}>
            THE PIYUMVERSE · BLOG
          </div>
          <div style={{ display: 'flex', fontSize: 64, fontWeight: 700, lineHeight: 1.12, maxWidth: 900 }}>
            {title}
          </div>
